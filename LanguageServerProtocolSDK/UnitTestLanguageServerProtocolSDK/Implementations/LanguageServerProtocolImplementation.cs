...
{
    class LanguageServerProtocolImplementation : LanguageServerProtocol
    {

        public LanguageServerProtocolImplementation(Stream inputStream, Stream outputStream)
            : base(inputStream, outputStream)
        {
        }

        public JsonRpcResponse ExposeProcessRequest(JsonRpcRequest request)
        {
            return this.ProcessRequest(request);
        }

        public JsonRpcResponse ExposeProcessMessage(string message)
        {
